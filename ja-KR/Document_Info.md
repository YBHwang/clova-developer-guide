  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li>[CEK] Clova Home Extension APIの <a href="/CEK/References/ClovaHomeInterface/Control_Interfaces.md#SetTargetTemperatureRequest">SetTargetTemperatureRequest</a>にendpointフィールドを追加し、<a href="/CEK/References/ClovaHomeInterface/Shared_Objects.md#EndpointInfoObject">EndpointInfoObject</a>オブジェクトを追加</li>
  ...
  <tr>
    ...
    <td>
      <ul>
        ...
        <li>[CIC] クライアントデバイスの設定を更新および同期するために、<a href="/CIC/References/CICInterface/Settings.html">Settings</a>名前欄を追加</li>
      </ul>
    </td>
  </tr>
  <tr>
...
<a href="/CIC/References/CICInterface/PlaybackController.html#ExpectResumeCommand">PlaybackController.ExpectResumeCommand</a>、<a href="/CIC/References/CICInterface/PlaybackController.html#ExpectStopCommand">PlaybackController.ExpectStopCommand</a>、<a href="/CIC/References/CICInterface/PlaybackController.html#SetRepeatMode">PlaybackController.SetRepeatMode</a>ディレクティブを追加</li>
          ...
          <li>[CIC] メディアストリームのための情報と、プレイリストを表示するための再生メタデータを分離するため、<a href="/CIC/References/CICInterface/TemplateRuntime.html">TemplateRuntime</a>名前欄を追加</li>

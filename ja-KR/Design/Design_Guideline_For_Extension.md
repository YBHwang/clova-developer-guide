...
* コンテンツを提供するために、サーバーと連携したりアカウントをリンクする場合、必要となる[セキュリティ要件](/CEK/Guides/Link_User_Account.md#ApplyAccountLinking)を満たしている必要があります。

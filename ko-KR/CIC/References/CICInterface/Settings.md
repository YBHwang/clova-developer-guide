...
<div class="note">
  ...
  <p>설정 정보를 업데이트하거나 동기화하는 설명은 <a href="/CIC/Guides/Implement_Client_Features.md#HandleSettings">설정 정보 처리하기</a>를 참조합니다.</p>
</div>
...
* [설정 정보 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleSettings)

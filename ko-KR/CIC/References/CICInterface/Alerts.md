...
<div class="note">
  ...
  <p>알람이 등록, 수정, 제거, 시작, 중지를 구현하는 방법은 <a href="/CIC/Guides/Implement_Client_Features.md#HandleAlerts">알람 처리하기</a>를 참조합니다.</p>
</div>
...
* [알람 시작하기](/CIC/Guides/ImplementClientFeatures/Handle_Alerts.md#RingAlert)
...
* [알람 중지하기](/CIC/Guides/ImplementClientFeatures/Handle_Alerts.md#StopAlert)
...
* [알람 수정 또는 삭제하기](/CIC/Guides/ImplementClientFeatures/Handle_Alerts.md#EditAlert)
...
* [알람 동기화하기](/CIC/Guides/ImplementClientFeatures/Handle_Alerts.md#SyncAlert)
...
* [알람 등록하기](/CIC/Guides/ImplementClientFeatures/Handle_Alerts.md#RegisterAlert)
* [알람 수정 또는 삭제하기](/CIC/Guides/ImplementClientFeatures/Handle_Alerts.md#EditAlert)

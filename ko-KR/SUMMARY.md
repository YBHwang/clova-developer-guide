...
* [Extension 디자인 가이드라인](/Design/Design_Guideline_For_Extension.md)
  ...
  * [Skill 이름 정의](/Design/Design_Guideline_For_Extension.md#DefineInvocationName)
  ...
  * [응답 유형 결정](/Design/Design_Guideline_For_Extension.md#DecideSoundOutputType)
    * [음성 출력 유형](/Design/Design_Guideline_For_Extension.md#OutputSpeech)
...
* [CIC 개요](/CIC/CIC_Overview.md)
  ...
  * [간접 대화 구조](/CIC/CIC_Overview.md#IndirectDialogue)
...
* [클라이언트 기능 구현하기](/CIC/Guides/Implement_Client_Features.md)
  * [대화 ID 관리 및 작업 처리하기](/CIC/Guides/Implement_Client_Features.md#ManageDialogueIDAndHandleTasks)
    * [대화 ID 생성하기](/CIC/Guides/Implement_Client_Features.md#CreatingDialogueID)
    * [대화 ID에 따라 메시지 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleDirectivesByDialogueID)
  * [위임된 사용자 요청 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleDelegation)
  * [클라이언트 동작 제어 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleDeviceControl)
    * [클라이언트 기기 설정 활성화하기](/CIC/Guides/Implement_Client_Features.md#HandleClientFeatureToggle)
    * [클라이언트 볼륨 조정하기](/CIC/Guides/Implement_Client_Features.md#HandleDeviceVolume)
    * [기기 상태 정보 공유하기](/CIC/Guides/Implement_Client_Features.md#HandleDeviceStateReport)
    * [처리 결과 보고하기](/CIC/Guides/Implement_Client_Features.md#HandleActionExecutedResponse)
  * [클라이언트 블루투스 제어 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleBluetoothControl)
    * [블루투스 기기에 대한 연결 요청 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleBluetoothConnect)
    * [블루투스 기기를 통한 음원 재생 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleBluetoothPlayAudio)
    * [블루투스 기기 연결 해제 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleBluetoothDisconnect)
    * [페어링된 블루투스 기기 삭제 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleBluetoothDelete)
  * [알람 처리하기](/CIC/Guides/Implement_Client_Features.md#HandleAlerts)
    * [알람 등록하기](/CIC/Guides/Implement_Client_Features.md#RegisterAlert)
    * [알람 시작하기](/CIC/Guides/Implement_Client_Features.md#RingAlert)
    * [알람 수정 또는 삭제하기](/CIC/Guides/Implement_Client_Features.md#EditAlert)
    * [알람 동기화하기](/CIC/Guides/Implement_Client_Features.md#SyncAlert)
...
* [Custom extension 만들기](/CEK/Guides/Build_Custom_Extension.md)
  ...
  * [Custom extension 요청 처리하기](/CEK/Guides/Build_Custom_Extension.md#HandleCustomExtensionRequest)
    ...
    * [요청 메시지 검증](/CEK/Guides/Build_Custom_Extension.md#RequestMessageValidation)
  ...
  * [오디오 콘텐츠 제공하기](/CEK/Guides/Build_Custom_Extension.md#ProvideAudioContent)
    * [오디오 콘텐츠 재생 지시](/CEK/Guides/Build_Custom_Extension.md#DirectClientToPlayAudio)
    * [오디오 콘텐츠 재생 제어](/CEK/Guides/Build_Custom_Extension.md#ControlAudioPlayback)
    * [오디오 콘텐츠의 메타 정보 제공](/CEK/Guides/Build_Custom_Extension.md#ProvidingMetaDataForDisplay)
...
* [Clova Home extension 만들기](/CEK/Guides/Build_Clova_Home_Extension.md)
  ...
  * [Clova Home extension 요청 처리하기](/CEK/Guides/Build_Clova_Home_Extension.md#HandleClovaHomeExtensionRequest)
    * [요청 메시지 검증](/CEK/Guides/Build_Clova_Home_Extension.md#RequestMessageValidation)

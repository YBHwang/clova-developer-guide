...
* [클라이언트 기능 구현하기](/CIC/Guides/Implement_Client_Features.md)
  * [대화 ID 관리 및 작업 처리하기](/CIC/Guides/ImplementClientFeatures/Manage_Dialogue_ID_And_Handle_Tasks.md)
    * [대화 ID 생성하기](/CIC/Guides/ImplementClientFeatures/Manage_Dialogue_ID_And_Handle_Tasks.md#CreatingDialogueID)
    * [대화 ID에 따라 메시지 처리하기](/CIC/Guides/ImplementClientFeatures/Manage_Dialogue_ID_And_Handle_Tasks.md#HandleDirectivesByDialogueID)
  ...
  * [클라이언트 블루투스 제어 처리하기](/CIC/Guides/ImplementClientFeatures/Handle_Bluetooth_Control.md)
    ...
    * [블루투스 기기를 통한 음원 재생 처리하기](/CIC/Guides/ImplementClientFeatures/Handle_Bluetooth_Control.md#HandleBluetoothPlayAudio)

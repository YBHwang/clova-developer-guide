      ...
      <td>
        <ul>
          <li>[CIC] <a href="/CIC/References/CICInterface/AudioPlayer.md">AudioPlayer</a> 네임스페이스에 메시지 스펙 추가 및 일부 필드 업데이트
            <ul>
              <li><a href="/CIC/References/CICInterface/AudioPlayer.md#ExpectReportPlaybackState">AudioPlayer.ExpectReportPlaybackState</a> 지시 메시지, <a href="/CIC/References/CICInterface/AudioPlayer.md#ReportPlaybackState">AudioPlayer.ReportPlaybackState 이벤트 메시지</a>{% if book.TargetReaderType == "Internal" %}, <a href="/CIC/References/CICInterface/AudioPlayer.md#RequestPlaybackState">AudioPlayer.RequestPlaybackState</a> 이벤트 메시지, <a href="/CIC/References/CICInterface/AudioPlayer.md#SynchronizePlaybackState">SynchronizePlaybackState 지시 메시지</a>{% endif %} 추가</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>[CIC] <a href="/CIC/References/ContextObjects/SpeechState.md">SpeechSynthesizer.SpeechState</a> 및 <a href="/CIC/References/CICInterface/SpeechSynthesizer.md">SpeechSynthesizer</a> 네임스페이스에 <a href="/CIC/References/CICInterface/SpeechSynthesizer.md#SpeechFinished">SpeechFinished</a>, <a href="/CIC/References/CICInterface/SpeechSynthesizer.md#SpeechStarted">SpeechStarted</a>, <a href="/CIC/References/CICInterface/SpeechSynthesizer.md#SpeechStopped">SpeechStopped</a> 이벤트 메시지 추가</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>[CIC] <a href="/CIC/References/CICInterface/Alerts.md">Alerts</a> API의 <a href="/CIC/References/CICInterface/Alerts.md#AlertsWorkFlow">동작 구조</a>에 대한 설명 개선</li>
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>[CIC] 알람 동기화에 대한 보충 설명을 <a href="/CIC/References/CICInterface/Alerts.md#AlertsWorkFlow">알람 동작 구조</a> 절에 추가</li>
